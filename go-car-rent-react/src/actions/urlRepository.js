...
export const BASE_GET_USER_MESSAGES_URL = BASE_API_URL + "/rents/messages?userId=:userId";
...
export const BASE_DELETE_MESSAGE_URL = BASE_API_URL + "/messages/:messageId/delete";
